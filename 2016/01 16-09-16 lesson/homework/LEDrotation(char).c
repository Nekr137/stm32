...
int main(void)
{
    static uint32_t LightTime;  //разобраться, что за переменная uint32_t
    RCC->AHBENR |= RCC_AHBENR_GPIOCEN; //!! непонятно, где про это написано подробнее. Нужно ли эту хрень вносить в мою функцию, или оставить в мэйне?     
